...
/// <c>Ai:RequestsPerMinute</c> (client-side throttle; free-tier RPM is the binding constraint),
...
public sealed record GeminiAiOptions
{
    ...
    public int RequestsPerMinute { get; init; } = 8;
    ...
    public static GeminiAiOptions From(IConfiguration configuration) => new()
    {
        ...
        RequestsPerMinute = configuration.GetValue("Ai:RequestsPerMinute", 8),
