...
/// and <c>Images:MaxSuggestions</c> — how many candidates a draft gets. Where editor uploads land
/// is <see cref="ImageStorageOptions"/>'s business (<c>Images:EditorUploadDir</c> beneath
/// <c>Images:StorageRoot</c>, ADR-0013).
/// </summary>
