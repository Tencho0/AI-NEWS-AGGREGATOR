...
| Q-10 | Manual (`/post`, `/new`-verbatim) drafts have no Category/SEO fields — Umbraco publishing requires them. Needs a default-category decision before `Publishing:FacebookOnly` is turned off. | Closed (2026-08-05) | Resolved by the button-based category/region/tags picker — see docs/superpowers/specs/2026-08-05-post-command-metadata-picker-design.md. |
