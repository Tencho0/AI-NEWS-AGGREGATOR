...
| Q-10 | ✅ **Resolved 2026-08-05** — manual (`/post`, `/new`-verbatim) drafts now get Category/Region/Tags via button-based picker (see docs/superpowers/specs/2026-08-05-post-command-metadata-picker-design.md); no AI involved | Done | — |
